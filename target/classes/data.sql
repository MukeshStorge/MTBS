...
VALUES(1, 'sweet', 'kristy', 'sweet.krisy@gmail.com', true) ON CONFLICT DO NOTHING;
INSERT INTO movie_booking."user"
(id, first_name, last_name, email, active_status)
VALUES(2, 'bubbly', 'snowflake', 'bubbly.snowflake@gmail.com', true) ON CONFLICT DO NOTHING;
INSERT INTO movie_booking."user"
(id, first_name, last_name, email, active_status)
VALUES(3, 'baby', 'butterfly', 'baby.butterfly@gmail.com', true) ON CONFLICT DO NOTHING;
